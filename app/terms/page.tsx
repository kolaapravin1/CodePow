  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl markdown">
      <section className="container mx-auto dark:text-white">
        ...
        <h2>Introduction</h2>
        <p>
          These terms constitute a legal agreement between you and CodePow Labs
          Incorporated ("CodePow," "we," or "us"). Your use of CodePow.dev (the
          "Site") and the services made available on the Site ("Services") is
          subject to these Terms of Service (these "Terms"). By using the Site
          and any of our Services, you:
        </p>
        <ul>
          <li>Acknowledge that you have read and understood these Terms</li>
          <li>Agree to be bound by these Terms</li>
          <li>Agree to our Privacy Policy (CodePow.dev/privacy-policy)</li>
        ...
        <p>
          ...
          non-exclusive, non-transferable license to use our Services. This
          license includes the right to use our Services for both personal and
          commercial purposes, subject to your subscription plan and these
          Terms.
        </p>
        ...
        <h3>Our rights</h3>
        <p>
          CodePow Labs Incorporated owns and retains all rights, title, and
          interest in and to:
        </p>

        <h4>Brand elements</h4>
        <ul>
          <li>The "CodePow" name and brand</li>
          <li>
            The "CodePow.dev" domain name and all related domains and variants
          </li>
          <li>The "GPT Engineer" trademark and brand and variants</li>
          <li>All CodePow logos, designs, and visual elements</li>
        ...
        <ul>
          <li>All text, graphics, and media on CodePow.dev</li>
        ...
        <p>
          These elements are protected by copyright, trademark, trade dress,
          patent laws, and other intellectual property rights.
        </p>

        <h3>Clear distinction of rights</h3>
        <p>
          To be explicitly clear, while CodePow owns all rights to the platform
          and brand elements described above, this ownership is entirely
          separate from and does not extend to:
        </p>
        <ul>
          ...
          <li>
            Your own code commits and changes made outside of CodePow but
            committed or visible in any way
          </li>
        </ul>

        <h3>User rights</h3>
        <p>CodePow makes no claim to ownership of:</p>
        <ul>
        ...
        <ul>
          <li>CodePow places no restrictions on your use of generated code</li>
          <li>
            You are free to use, modify, and distribute generated code without
            attribution requirements
          </li>
          <li>
            No licenses or royalties are owed by CodePow users to CodePow for
          ...
          <li>
            ...
            approval from CodePow
          </li>
        </ul>

        <h2>Data usage, training, and learning</h2>
        <p>
          We collect and process data from your use of the Services to improve
          our platform, provide support, and enhance user experience. While our
          Privacy policy contains detailed information about data collection and
        ...
        <ul>
          <li>
            Train and refine our AI systems, improving their ability to
            understand developer requirements and generate appropriate code
          </li>
          <li>
          ...
          <li>
            Develop new features and capabilities based on user needs and
            behavior
          </li>
        </ul>
        ...
        <p>
          We utilize collected data to provide comprehensive support and
          maintain optimal platform operations. This includes monitoring system
          performance, analyzing error patterns, and generating internal reports
          that help us maintain and improve service quality. Our support team
        ...
        <ul>
          ...
          <li>
            Generate insights that help improve our documentation and user
            guides
          </li>
        ...
        <p>
          Enterprise customers receive enhanced data protection and control. For
          these users:
        </p>
        <ul>
          <li>
            We explicitly waive our right to use their data for training
            purposes
          </li>
        ...
        <p>
          For complete details about data collection, processing, and your
          privacy rights, please refer to our Privacy policy at
          CodePow.dev/privacy-policy.
        </p>
        ...
        <ul>
          ...
          <li>Paid plans: As described at https://CodePow.dev/pricing</li>
        ...
        <ul>
          ...
          <li>Contact via CodePowai@gmail.com</li>
        ...
        <ul>
          <li>
            Access to our platform is granted immediately upon successful
            payment processing
          </li>
          <li>You will receive login credentials via email</li>
          <li>
            If you experience any issues with access, contact
            CodePowai@gmail.com
          </li>
        </ul>
        ...
        <p>
          ...
          Millennium Copyright Act (DMCA). For any DMCA-related issues, contact
          us at CodePowai@gmail.com with:
        </p>
        <ul>
          <li>
        ...
        <p>
          CodePow may never be used to develop anything subjected to sanctions
          or other export restrictions, or are in any other way not compliant
          with the laws of the jurisdiction that CodePow or the user operates
          in. CodePow may also never be used by in regions, or by anyone subject
        ...
        <ul>
          ...
          <li>
            Providing feedback grants us a perpetual, worldwide license to use
            it
          </li>
        ...
        <p className="uppercase">
          YOUR USE OF THE SITE, SERVICES AND ALL CodePow CONTENT IS ENTIRELY AT
          YOUR OWN RISK. THE PLATFORM, SERVICES, AND ALL CONTENT ARE PROVIDED
          "AS IS" AND "AS AVAILABLE" WITHOUT ANY GUARANTEES. TO THE FULLEST
          EXTENT PERMITTED BY LAW, CodePow AND OUR SUPPLIERS AND LICENSORS
          EXPLICITLY DISCLAIM ALL WARRANTIES, WHETHER EXPRESS OR IMPLIED,
          INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY,
          FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. WE MAKE
          NO GUARANTEES REGARDING THE ACCURACY, RELIABILITY, OR USEFULNESS OF
          THE PLATFORM, SERVICES, OR ANY CodePow CONTENT, AND YOUR USE OF THESE
          IS ENTIRELY AT YOUR OWN RISK. ANY MATERIALS OR CODE YOU DOWNLOAD OR
          ACCESS THROUGH OUR PLATFORM OR SERVICES IS OBTAINED AT YOUR OWN
          DISCRETION AND RISK, AND YOU WILL BE SOLELY RESPONSIBLE FOR ANY SYSTEM
          DAMAGE OR DATA LOSS THAT MAY RESULT. NO ORAL OR WRITTEN INFORMATION OR
          ADVICE PROVIDED BY US OR THROUGH OUR PLATFORM OR SERVICES SHALL CREATE
          ANY WARRANTY NOT EXPRESSLY STATED IN THIS AGREEMENT. CERTAIN
          JURISDICTIONS MAY PROHIBIT SUCH WARRANTY DISCLAIMERS, SO SOME OR ALL
          OF THESE LIMITATIONS MAY NOT APPLY TO YOU.
        </p>

        <h2>Limitation of liability</h2>
        <p className="uppercase">
          CodePow, ALONG WITH ITS AFFILIATES, AGENTS, OFFICERS, EMPLOYEES,
          ...
          ARISING FROM YOUR USE OF OR INABILITY TO USE OUR PLATFORM, SERVICES,
          OR CodePow CONTENT. UNDER NO CIRCUMSTANCES WILL CodePow BE HELD
          RESPONSIBLE FOR ANY DAMAGES OR LOSSES RESULTING FROM UNAUTHORIZED
          ACCESS, SECURITY BREACHES, OR INTERFERENCE WITH OUR PLATFORM,
          SERVICES, OR YOUR ACCOUNT.
        </p>

        <p className="uppercase">
          TO THE MAXIMUM EXTENT ALLOWED BY LAW, CodePow ACCEPTS NO LIABILITY OR
          RESPONSIBILITY FOR:
        </p>
        ...
        <ul className="uppercase">
          ...
          <li>
            Any errors, losses, or damages arising from the use of our content
            or services
          </li>
        </ul>
        ...
        <p className="uppercase">
          THIS LIST IS NOT EXHAUSTIVE, AND CodePow'S LIMITATION OF LIABILITY
          EXTENDS TO ALL POSSIBLE ISSUES, WHETHER LISTED HERE OR NOT, ARISING
          FROM THE USE OF OUR AI-POWERED PLATFORM AND SERVICES.
        </p>
        ...
        <p className="uppercase">
          ...
          SERVICES, AND CodePow CONTENT (INCLUDING WARRANTY CLAIMS), REGARDLESS
          OF THE TYPE OF CLAIM OR LEGAL THEORY, EXCEED THE AMOUNT YOU HAVE PAID
          TO US FOR THE SERVICES IN THE TWELVE MONTHS PRECEDING THE CLAIM. IF
          YOU RESIDE IN CALIFORNIA, YOU WAIVE CALIFORNIA CIVIL CODE §1542, WHICH
          ...
          LIABILITY LIMITATIONS FOR CERTAIN DAMAGES, SO THESE LIMITATIONS MAY
          NOT FULLY APPLY TO YOU.
        </p>

        <h2>Indemnification</h2>
        <p>
          You agree to defend, indemnify, and hold harmless CodePow, including
        ...
        <p>
          ...
          regulations. Access is prohibited from United States embargoed
          countries or by denied or restricted parties under U.S. law.
        </p>
        ...
        <p>
          ...
          platform must be brought exclusively in the courts of Delaware, and
          you consent to the personal jurisdiction of these courts. Our failure
          to exercise any right or provision of these Terms doesn't constitute a
