    ...
    >
      <div className="flex items-center gap-2 z-logo text-bolt-elements-textPrimary cursor-pointer">
        ...
        >
          ...
          <span className="inline-block mr-1">CodePow</span>
          <img
            src="/logo-04.png"
            alt="logo"
            className="w-[24px] inline-block dark:hidden"
          />
          <img
            src="/logo-04.png"
            alt="logo"
            className="w-[24px] inline-block hidden dark:block"
          />
        </a>
      </div>
      ...
      {!session && (
        <div className="flex items-center gap-4 ml-auto z-10">
          <Link href="/login">
            <Button
              size="sm"
              className="bg-purple-500 dark:bg-purple-500 text-purple-700 dark:text-purple-200 hover:bg-purple-100 dark:hover:bg-purple-500/80 rounded-lg"
            >
              Sign In
            </Button>
          </Link>
